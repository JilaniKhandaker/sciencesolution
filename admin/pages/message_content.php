...
<script>
    function select_notice(given_text, obj_id) {
        ...
        server_page='ajax_check.php?message='+given_text;
...
<div class="row-fluid sortable">		
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <list>
            <ul>
                <li> <button onclick="select_notice(this.value, 'sn');" value="in_message" > Individual Message  </button></li>
                <li> <button onclick="select_notice(this.value, 'sn');" value="batch_message" > Message to a batch   </button></li>
                <li> <button onclick="select_notice(this.value, 'sn');" value="all_message" > Message to all  </button></li>
            </ul>
            </list>
